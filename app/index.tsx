        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.box}>
                ...
                <View style={{width: 200, alignItems: 'center'}}>
                    <Text style={{color: '#B66A08FF', fontFamily: 'Karla', fontWeight: 'bold'}}>Não tem uma conta?</Text>
                    <Link href={'/register'} style={{color: '#D3A832FF', fontFamily: 'Karla', fontWeight: 'bold'}}>Cadastrar</Link>
                </View>
            </View>
